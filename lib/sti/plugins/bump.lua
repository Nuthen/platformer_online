	...
	bump_init = function(map, world)
		...
		for _, tileset in ipairs(map.tilesets) do
			for _, tile in ipairs(tileset.tiles) do
				...
				if tile.properties and (tile.properties.collidable == "true" or tile.properties.collidable) and map.tileInstances[gid] then
		...
		for _, layer in ipairs(map.layers) do
			-- Entire layer
			if layer.properties.collidable == "true" or layer.properties.collidable then
            ...
            if layer.type == "objectgroup" then
				for _, obj in ipairs(layer.objects) do
					if (layer.properties and layer.properties.collidable == "true" or layer.properties.collidable)
					  or (obj.properties and obj.properties.collidable == "true" or obj.properties.collidable) then
